...
macro(add_archer_library name)
  ...
  set_target_properties(${name} PROPERTIES FOLDER "Archer")
  ...
  if(ARCHER_LINK_LIBS)
    foreach(lib ${ARCHER_LINK_LIBS})
      target_link_libraries(${name} ${lib})
    endforeach(lib)
  endif(ARCHER_LINK_LIBS)
...
endmacro(add_archer_library)

macro(add_archer_loadable_module name)
  set(srcs ${ARGN})
...
endmacro(add_archer_loadable_module)
