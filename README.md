...
<table border="2" cellspacing="0" cellpadding="6" rules="all" frame="border" style="table { border: 1px solid green; border-collapse: collapse; width:100%; } table td { border: 1px solid green; width: 99% }">
