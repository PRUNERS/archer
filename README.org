...
#+HTML: <img src="resources/images/uofu_logo.png" hspace="5" vspace="5" height="25%" width="25%" alt="UofU Logo" title="University of Utah" style="float:left" />
#+HTML: <img src="resources/images/llnl_logo.png" hspace="5" vspace="5" height="30%" width="30%" alt="LLNL Logo" title="Lawrence Livermore National Laboratory" style="float:center" />
#+HTML: <img src="resources/images/rwthaachen_logo.png" hspace="5" vspace="5" height="30%" width="30%" alt="RWTH AACHEN Logo" title="RWTH AACHEN University" style="float:left" />
