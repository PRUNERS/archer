...
int main()
{
  ...
  // THREADS: {{^}}[[MASTER_ID]]: ompt_event_task_create: parent_task_id=0, parent_task_frame.exit={{0x0|\(nil\)}}, parent_task_frame.reenter={{0x0|\(nil\)}}, new_task_id=281474976710658, codeptr_ra={{0x0|\(nil\)}}, task_type=ompt_task_initial=1, has_dependences=no
